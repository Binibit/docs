...
- [Staking page](https://binibit.com/en/staking/level-conditions) on Binibit Exchange (canonical, has live values)
- [Staking conditions / referral levels](https://binibit.com/en/staking/level-conditions)
...
Each tier has a minimum BINI amount. Specific values are on the [staking page](https://binibit.com/en/staking/level-conditions) — they may change with BINI price, since the underlying threshold is in **USDT terms**.
...
[Binibit Exchange — Staking](https://binibit.com/en/staking/level-conditions)
