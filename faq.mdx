...
<AccordionGroup>
  ...
  <Accordion title="Do I need an API key?">
    ...
    The trading API on `public-api.binibit.com` (create/cancel orders, withdrawals) does require HMAC-SHA256 request signing with an API key + secret — see the [v2 roadmap](/changelog#roadmap).
  </Accordion>
  ...
  <Accordion title="Is there a WebSocket API?">
    Not yet. WebSocket streams for tickers, order book, and trades are on the [v2 roadmap](/changelog#roadmap). Watch the [GitHub repo](https://github.com/Binibit/docs) for release notifications.
  </Accordion>
