...
| **BaiDEX / Launchpad / Hive APIs** | TBD during v2.0 rollout | TBD |
...
| Version | Scope |
|---|---|
| **v1.x** (live) | Spot Market API only (public-api.binibit.com + aggregator-spec namespace) |
| **v2.0** (in progress) | Full ecosystem: BiniChain, BaiDEX, AgentT Launchpad, Agent Hive, Bini App, BINI Token, Tokenomics |
| **v2.x** (planned) | OHLC docs, status page, OpenAPI playground per endpoint |
| **v3.0** (planned) | Authenticated trading API + WebSocket streams |
