...
```
User spawns Agent Token  →  burns BINI (spawn cost)
                          →  Worker assigned, Pool listed
                          →  Pool generates swaps
                          →  more BINI burned per swap
                          →  reduces BINI float
                          →  raises BINI price (ceteris paribus)
                          →  more attractive to spawn more tokens
```
