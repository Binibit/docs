...
Available at [binibit.com/en/staking](https://binibit.com/en/staking/level-conditions).
...
Exact thresholds and percentages: see [binibit.com/en/staking/level-conditions](https://binibit.com/en/staking/level-conditions). They are the canonical source — this docs page is a roadmap, not a quote.
...
<CardGroup cols={2}>
  ...
  <Card title="Staking page" icon="lock" href="https://binibit.com/en/staking/level-conditions">
